KanbanReport = function(columnConfig, rallyDataSource) {
        var that = this;
    
        var dialog, report, divId, msgDiv;
        var artifactTypes = columnConfig.artifactTypes;
        var reportName = columnConfig.reportName;
        ...
        that._createReport = function() {
            ...
            reportConfig = {
                report: columnConfig.reportNumber,
            ...
            if (columnConfig.reportKanbanField !== "Schedule State") {
                reportConfig.filter_field = columnConfig.reportKanbanField;
            }
    
            if (columnConfig.tags) {
                reportConfig.tags = columnConfig.tags;
            }
