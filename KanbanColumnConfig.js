...
KanbanColumnConfigPanel = function(rallyDataSource, onConfigHide) {
        ...
        var stateDropdown, dialog, classOfServiceFieldDropdown;
		
        var allAttributes = {}, scheduleStateValues = {}, classOfServiceValues = {};
        ...
        that.displayDialog = function() {
            ...
            function createDialog(names) {
                var content = dojo.byId("columnConfigPanel");
                var title;
                dojo.byId("columnConfigPanel").style.visibility = "visible";
        ...
        that._storeValues = function(callback) {
            ...
            function updateAppPreference(pref) {
				...
				var newPrefs = currentPrefs;
				
				rally.forEach(that._getValues(), function(pref, key) {
                        if (key === "fieldInfos") {
							newPrefs.fieldInfos = pref;
						}
						else if (key !== "cosFieldInfos") {
							if(pref) {
								newPrefs[key] = pref;			
							}
						}
